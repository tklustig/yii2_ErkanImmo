...
class m190421_233024_Mass extends Migration {
    ...
    public function safeUp() {
        ...
        $this->createTable('{{%firma}}', [
            ...
            'bankdaten' => $this->string(256)->notNull()->defaultValue(null),
        ...
        $this->addForeignKey(
                'fk_adminbesichtigungkunde_admin_id', '{{%adminbesichtigungkunde}}', 'admin_id', '{{%user}}', 'id', 'SET NULL', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_adminbesichtigungkunde_besichtigungstermin_id', '{{%adminbesichtigungkunde}}', 'besichtigungstermin_id', '{{%besichtigungstermin}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_adminbesichtigungkunde_kunde_id', '{{%adminbesichtigungkunde}}', 'kunde_id', '{{%kunde}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_bankverbindung_aktualisiert_von', '{{%bankverbindung}}', 'aktualisiert_von', '{{%user}}', 'id', 'SET NULL', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_bankverbindung_angelegt_von', '{{%bankverbindung}}', 'angelegt_von', '{{%user}}', 'id', 'SET NULL', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_bankverbindung_kunde_id', '{{%bankverbindung}}', 'kunde_id', '{{%kunde}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_besichtigungstermin_aktualisiert_von', '{{%besichtigungstermin}}', 'aktualisiert_von', '{{%user}}', 'id', 'SET NULL', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_besichtigungstermin_Immobilien_id', '{{%besichtigungstermin}}', 'Immobilien_id', '{{%immobilien}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_besichtigungstermin_angelegt_von', '{{%besichtigungstermin}}', 'angelegt_von', '{{%user}}', 'id', 'SET NULL', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_dateianhang_aktualisiert_von', '{{%dateianhang}}', 'aktualisiert_von', '{{%user}}', 'id', 'SET NULL', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_dateianhang_e_dateianhang_id', '{{%dateianhang}}', 'e_dateianhang_id', '{{%e_dateianhang}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_dateianhang_l_dateianhang_art_id', '{{%dateianhang}}', 'l_dateianhang_art_id', '{{%l_dateianhang_art}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_dateianhang_angelegt_von', '{{%dateianhang}}', 'angelegt_von', '{{%user}}', 'id', 'SET NULL', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_e_dateianhang_user_id', '{{%e_dateianhang}}', 'user_id', '{{%user}}', 'id', 'SET NULL', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_e_dateianhang_immobilien_id', '{{%e_dateianhang}}', 'immobilien_id', '{{%immobilien}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_e_dateianhang_kunde_id', '{{%e_dateianhang}}', 'kunde_id', '{{%kunde}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_e_dateianhang_mail_id', '{{%e_dateianhang}}', 'mail_id', '{{%mail}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_firma_angelegt_von', '{{%firma}}', 'angelegt_von', '{{%user}}', 'id', 'SET NULL', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_firma_aktualisiert_von', '{{%firma}}', 'aktualisiert_von', '{{%user}}', 'id', 'SET NULL', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_firma_l_plz_id', '{{%firma}}', 'l_plz_id', '{{%l_plz}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_firma_l_rechtsform_id', '{{%firma}}', 'l_rechtsform_id', '{{%l_rechtsform}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_immobilien_l_art_id', '{{%immobilien}}', 'l_art_id', '{{%l_art}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_immobilien_aktualisiert_von', '{{%immobilien}}', 'aktualisiert_von', '{{%user}}', 'id', 'SET NULL', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_immobilien_l_heizungsart_id', '{{%immobilien}}', 'l_heizungsart_id', '{{%l_heizungsart}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_immobilien_angelegt_von', '{{%immobilien}}', 'angelegt_von', '{{%user}}', 'id', 'SET NULL', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_kopf_user_id', '{{%kopf}}', 'user_id', '{{%user}}', 'id', 'SET NULL', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_kunde_bankverbindung_id', '{{%kunde}}', 'bankverbindung_id', '{{%bankverbindung}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_kunde_aktualisiert_von', '{{%kunde}}', 'aktualisiert_von', '{{%user}}', 'id', 'SET NULL', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_kunde_l_plz_id', '{{%kunde}}', 'l_plz_id', '{{%l_plz}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_kunde_geschlecht', '{{%kunde}}', 'geschlecht', '{{%l_geschlecht}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_kundeimmobillie_immobilien_id', '{{%kundeimmobillie}}', 'immobilien_id', '{{%immobilien}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_kundeimmobillie_kunde_id', '{{%kundeimmobillie}}', 'kunde_id', '{{%kunde}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_mail_id_mailserver', '{{%mail}}', 'id_mailserver', '{{%mailserver}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_mail_angelegt_von', '{{%mail}}', 'angelegt_von', '{{%user}}', 'id', 'SET NULL', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_mail_aktualisiert_von', '{{%mail}}', 'aktualisiert_von', '{{%user}}', 'id', 'SET NULL', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_mail_textbaustein_id', '{{%mail}}', 'textbaustein_id', '{{%l_textbaustein}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_mailserver_angelegt_von', '{{%mailserver}}', 'angelegt_von', '{{%user}}', 'id', 'SET NULL', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_mailserver_aktualisiert_von', '{{%mailserver}}', 'aktualisiert_von', '{{%user}}', 'id', 'SET NULL', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_rechnung_kopf_id', '{{%rechnung}}', 'kopf_id', '{{%kopf}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_rechnung_kunde_id', '{{%rechnung}}', 'kunde_id', '{{%kunde}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_rechnung_makler_id', '{{%rechnung}}', 'makler_id', '{{%user}}', 'id', 'SET NULL', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_rechnung_mwst_id', '{{%rechnung}}', 'mwst_id', '{{%l_mwst}}', 'id', 'RESTRICT', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_rechnung_angelegt_von', '{{%rechnung}}', 'angelegt_von', '{{%user}}', 'id', 'SET NULL', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_rechnung_aktualisiert_von', '{{%rechnung}}', 'aktualisiert_von', '{{%user}}', 'id', 'SET NULL', 'CASCADE'
        );
        $this->addForeignKey(
                'fk_rechnung_rechungsart_id', '{{%rechnung}}', 'rechungsart_id', '{{%l_rechnungsart}}', 'id', 'RESTRICT', 'CASCADE'
        );
    }

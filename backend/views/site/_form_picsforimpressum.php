...
<div class="jumbotron">
    <div class="container">
        <div class="page-header"><h2><?= Html::encode($this->title) ?><small>Sie können genau ein Theme über die DropDown-Box initialisieren</small></h2>
             <div class="alert alert-success" role="alert">Das von ihnen initialiserte Bild wird im Impressum als themeImpressum.jpg jedesmal auf's neue überschrieben.</div>

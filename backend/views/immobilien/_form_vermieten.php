...
<div class="immobilien-form">
    ...
    if ($model->isNewRecord) {
        $this->title = Yii::t('app', 'Mietobjekt anlegen');
    } else {
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        $form->field($model, 'bezeichnung', ['addon' => [
                                'prepend' => ['content' => 'Mietwohnung-Beschreibung']]])->widget(\dosamigos\ckeditor\CKEditor::className(), [
                    ...
                    <div class="col-md-6">
                        ...
                        $form->field($model, 'geldbetrag', ['addon' => [
                                'prepend' => ['content' => 'Miete'], 'append' => ['content' => '€']]])->textInput(['placeholder' => 'Geben Sie hier die Nettomiete an'])
                        ?>
                    </div>
                    <div class="col-md-6">
                        <?=
                                $form->field($model, 'v_nebenkosten', ['addon' => [
                                        'prepend' => ['content' => 'Nebenkosten'], 'append' => ['content' => '€']]])->widget(TwbsMaxlength::className())
                                ->textInput(['maxlength' => true, 'placeholder' => 'Bitte die Nebenkosten angeben']);
                        ?>
                    </div>
                    <div class="col-md-6">
                        <?=

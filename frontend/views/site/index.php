...
?>
<div style="background:url(<?= $url ?>accept_all_you_see-wallpaper-1680x1050_copy.jpg);  background-repeat: no-repeat;  background-size: 100% 100%; background-position:center top;">
